...
<?php include_once __DIR__.'/../layout/menu.php'; ?>
  <div class="content-wrapper">
    ...
    <section class="content container-fluid" onload="updateSize();">
        <?php 
         if($response[0]=="edit"){$action="updatearea";$btn="Update Area";}else{$action="addarea";$btn="Add Area";}
        ?>
                        ...
                        <div class="box-body" <?php echo $b_body ?>>
                            <div class="col-md-12">
                                <div class=" form-group">
                                    ...
                                    <input class=" form-control" onkeypress="return isAlphaOnly(event)" maxlength="50"  value="<?php echo $response[1]; ?>" name="areaname" id="areaname" placeholder="Enter area name" required>
                                </div>
                            </div>
                            <div class="col-md-12">
        ...
        <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        ...
                        echo $this->pagination("area",$limit,$cpage); ?>
                       </div>
                    </div>
...
<script>
  $(function () {
    ...
    $('.table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url : "<?php echo ADMIN_URL ?>getAreaRecord/"+limit+"/"+cpage,
            type:"post"
  ...
  function deleteArea(x){
      if(confirm("Are you sure to delete?")){
        var url = "<?php echo ADMIN_URL ?>deleteArea/"+x;
        $.ajax({
            url: url,
            success: function(res){
                if(res=="1"){
                    ...
                    alertify.sujeet("<p <?php echo MSG_ERR ?>>Can't Delete This Area. Related Data found!.</p>");
                }
            }
        })
      }
