...
<?php include_once __DIR__.'/../layout/menu.php'; ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Add/Manage News Category <small></small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content container-fluid" onload="updateSize();">
        <?php 
         if($response[0]=="edit"){$action="updatenewscat";$btn="Update News Category";}else{$action="addnewscat";$btn="Add News Category";}
        ?>
                        ...
                        <div class="box-body" <?php echo $b_body ?>>
                            <div class="col-md-12">
                                <div class=" form-group">
                                    ...
                                    <input class=" form-control" onkeypress="return isAlphaOnly(event)" maxlength="50"  value="<?php echo $response[1]; ?>" name="newscatname" id="newscatname" placeholder="Enter News Category" required>
                                </div>
                            </div>
                            <div class="col-md-12">
        ...
        <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        ...
                        echo $this->pagination("newscat",$limit,$cpage); ?>
                       </div>
                    </div>
...
<script>
  $(function () {
    ...
    $('.table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url : "<?php echo ADMIN_URL ?>getnewscatRecord/"+limit+"/"+cpage,
            type:"post"
            
        }
    });
  })
  function deletenewscat(x){
      if(confirm("Are you sure to delete?")){
        var url = "<?php echo ADMIN_URL ?>deletenewscat/"+x;
        $.ajax({
            url: url,
            success: function(res){
                if(res=="1"){
                    ...
                    alertify.sujeet("<p <?php echo MSG_ERR ?>>Can't Delete This newscat. Related Data found!.</p>");
                }
            }
        })
      }
